...
import com.alexitodev.estacionamientoapp.main.ui.dashboard.dialogmodel.BluetoothDeviceSelectionDialog
import com.alexitodev.estacionamientoapp.main.ui.dashboard.dialogmodel.sampleDevices
...
private fun BluetoothDeviceSection() {
    ...
    if (showDialog) {
        BluetoothDeviceSelectionDialog(
            devices = sampleDevices, // Usamos datos de ejemplo por ahora
