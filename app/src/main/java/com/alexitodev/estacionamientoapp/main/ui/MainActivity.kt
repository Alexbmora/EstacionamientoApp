package com.alexitodev.estacionamientoapp.main.ui
...
import com.alexitodev.estacionamientoapp.main.domain.SystemState
import com.alexitodev.estacionamientoapp.main.domain.telegram.logger.LogEntry
import com.alexitodev.estacionamientoapp.main.ui.dashboard.*
import com.alexitodev.estacionamientoapp.main.ui.dashboard.viewmodels.DashboardViewModel
import com.alexitodev.estacionamientoapp.main.ui.dashboard.viewmodels.DashboardViewModelFactory
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.checkInitialWorkStatus(applicationContext)
...
fun ViewContainer(
    ...
    val systemState by viewModel?.systemState?.collectAsState(initial = SystemState()) ?: remember { mutableStateOf(SystemState()) }
    ...
    val notificationPermissionLauncher = rememberLauncherForActivityResult(
        ...
        onResult = { isGranted ->
            if (isGranted) {
                viewModel?.startWork(context) // Si se concede, iniciamos el trabajo
            } else {
    ...
    Scaffold(
        ...
        topBar = {
            MainTopAppBar(
                ...
                onMenuClick = { Toast.makeText(context, "Menú presionado", Toast.LENGTH_SHORT).show() }
            )
        },
