...
import com.alexitodev.estacionamientoapp.data.PreferencesRepository
...
class TelegramBot @Inject constructor(
    ...
    suspend fun initialize() {
        lastUpdateId = preferencesRepository.getLastUpdateId()
    }
    ...
    suspend fun checkAndHandleNewMessages() {
        ...
        result.onSuccess { updates ->
            ...
            if (newUpdates.isNotEmpty()) {
                ...
                preferencesRepository.saveLastUpdateId(lastUpdateId)
    ...
    private suspend fun handleMessage(message: com.alexitodev.estacionamientoapp.data.telegram.TelegramMessage) {
